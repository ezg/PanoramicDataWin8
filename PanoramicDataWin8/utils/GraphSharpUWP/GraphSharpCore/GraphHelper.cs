...
namespace GraphSharp
{
    ...
    public class Rect {
        ...
        public Windows.Foundation.Size Size => new Windows.Foundation.Size(Width, Height);
    ...
    public class Vector
    {
        ...
        public static Point operator +(Point p1, Vector v2)
        {
    ...
    public static class GraphHelper
    {
            ...
            where Graph : IBidirectionalGraph<Vertex, Edge>
        {
            ...
            foreach ( Vertex source in g.Vertices )
            {
                ...
                var spaDijkstra =
                    new UndirectedDijkstraShortestPathAlgorithm<Vertex, Edge>(undirected, (edge) => weights[edge], QuickGraph.Algorithms.DistanceRelaxers.ShortestDistance);//bcz: ShortestDistanceRelaxer.Instance );
            ...
            where TVertex : class
        {
            ...
            throw new NotImplementedException(); // bcz:
