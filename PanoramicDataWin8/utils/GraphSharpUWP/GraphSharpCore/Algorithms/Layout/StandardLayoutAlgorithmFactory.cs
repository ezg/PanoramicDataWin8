...
namespace GraphSharp.Algorithms.Layout
{
    ...
    {
        public enum AlgorithmTypeNames {
            Circular,
            Tree,
            FR,
            BoundedFR,
        ...
        {
            get { return new[] { AlgorithmTypeNames.Circular.ToString(),
                 AlgorithmTypeNames.Tree.ToString(),
                 AlgorithmTypeNames.FR.ToString(),
                 AlgorithmTypeNames.BoundedFR.ToString(),
                 AlgorithmTypeNames.KK.ToString(), 
                 AlgorithmTypeNames.ISOM.ToString(),
                 AlgorithmTypeNames.LinLog.ToString(),
                 AlgorithmTypeNames.EfficientSugiyama.ToString(), /*"Sugiyama",*/
                 AlgorithmTypeNames.CompoundFDP.ToString() }; }
        }
