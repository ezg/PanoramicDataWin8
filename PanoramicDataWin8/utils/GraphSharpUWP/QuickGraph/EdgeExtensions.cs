...
this 
            ...
            where TEdge : IEdge<TVertex>
        {
            ...
            //bcz :Contract.Requires(typeof(TEdge).IsValueType || Enumerable.All(path, e => e != null));
...
this 
            ...
            where TEdge : IEdge<TVertex>
        {
            ...
            Contract.Requires(vertex != null);
            //bcz :Contract.Requires( typeof(TEdge).IsValueType ||  Enumerable.All(predecessors.Values, e => e != null));
...
this 
            ...
            where TEdge : IEdge<TVertex>
        {
            ...
            //bcz : Contract.Requires( typeof(TEdge).IsValueType || Enumerable.All(predecessors.Values, e => e != null));
            //bcz : Contract.Ensures( !Contract.Result<bool>() || (Contract.ValueAtReturn<IEnumerable<TEdge>>(out result) != null && (typeof(TEdge).IsValueType || Enumerable.All(  Contract.ValueAtReturn<IEnumerable<TEdge>>(out result), e => e != null)) ) );
