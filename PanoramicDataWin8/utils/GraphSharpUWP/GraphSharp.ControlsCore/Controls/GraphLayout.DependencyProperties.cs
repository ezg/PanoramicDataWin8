...
namespace GraphSharp.Controls
{
        ...
        where TGraph : class, IBidirectionalGraph<TVertex, TEdge>
    {
        ...
        public static readonly DependencyProperty AnimationDisablerVertexCountProperty =
            DependencyProperty.Register("AnimationDisablerVertexCount", typeof(int), typeof(GraphLayout<TVertex, TEdge, TGraph>), new PropertyMetadata(200)); // bcz:  new UIPropertyMetadata(200));
        ...
        public static readonly DependencyProperty AnimationDisablerEdgeCountProperty =
            DependencyProperty.Register("AnimationDisablerEdgeCount", typeof(int), typeof(GraphLayout<TVertex, TEdge, TGraph>), new PropertyMetadata(500)); // bcz: new UIPropertyMetadata(500));
        ...
        public static readonly DependencyProperty AsyncComputeProperty = DependencyProperty.Register("AsyncCompute",
                                                                                               ...
                                                                                               new PropertyMetadata(false)); // bcz: new UIPropertyMetadata( false ) );
        public static readonly DependencyProperty EdgeRoutingAlgorithmFactoryProperty =
            DependencyProperty.Register("EdgeRoutingAlgorithmFactory",
                                        ...
                                        new PropertyMetadata(
                                            ...
                                            null)); // bcz: , EdgeRoutingAlgorithmFactory_Coerce));

        public static readonly DependencyProperty EdgeRoutingAlgorithmProperty;

        protected static readonly DependencyProperty EdgeRoutingAlgorithmPropertyKey =// bcz: DependencyPropertyKey
            DependencyProperty.Register("EdgeRoutingAlgorithm",// bcz: RegisterReadOnly
                                                typeof(IEdgeRoutingAlgorithm<TVertex, TEdge, TGraph>),
                                                typeof(GraphLayout<TVertex, TEdge, TGraph>),
                                                 new PropertyMetadata(null)); // bcz: new UIPropertyMetadata( null ) );
        ...
        public static readonly DependencyProperty GraphProperty = DependencyProperty.Register("Graph", typeof(TGraph),
                                        typeof(GraphLayout<TVertex, TEdge, TGraph>),
                                        new PropertyMetadata(null, Graph_PropertyChanged)); // bcz:  FrameworkPropertyMetadata(null,FrameworkPropertyMetadataOptions.AffectsRender,Graph_PropertyChanged));
        ...
        public static readonly DependencyProperty HighlightAlgorithmProperty; // bcz:

        public static readonly DependencyProperty  HighlightAlgorithmPropertyKey  =// bcz: DependencyPropertyKey
            DependencyProperty.Register("HighlightAlgorithm",// bcz: RegisterReadOnly
                                                typeof(IHighlightAlgorithm<TVertex, TEdge, TGraph>),
                                                typeof(GraphLayout<TVertex, TEdge, TGraph>),
                                                new PropertyMetadata(null, HighlightAlgorithm_PropertyChanged)); // bcz: UIPropertyMetadata
        ...
        public static readonly DependencyProperty HighlightAlgorithmTypeProperty =
            DependencyProperty.Register("HighlightAlgorithmType", typeof(string),
                                        typeof(GraphLayout<TVertex, TEdge, TGraph>),
                                        new PropertyMetadata(string.Empty, HighlightAlgorithmType_PropertyChanged)); // bcz: , HighlightAlgorithmType_Coerce));
        ...
        public static readonly DependencyProperty HighlightParametersProperty =
            DependencyProperty.Register("HighlightParameters", typeof(IHighlightParameters),
                                        typeof(GraphLayout<TVertex, TEdge, TGraph>),
                                        new PropertyMetadata(null, null)); // bcz: , HighlightParameters_Coerce));
        ...
        public static readonly DependencyProperty LayoutAlgorithmFactoryProperty =
            DependencyProperty.Register("LayoutAlgorithmFactory",
                                        ...
                                        typeof(GraphLayout<TVertex, TEdge, TGraph>),
                                        new PropertyMetadata(
                                            new StandardLayoutAlgorithmFactory<TVertex, TEdge, TGraph>(), null));  // bcz: , LayoutAlgorithmFactory_Coerce));

        public static readonly DependencyProperty LayoutAlgorithmProperty; // bcz:

        protected static readonly DependencyProperty  LayoutAlgorithmPropertyKey =// bcz: DependencyPropertyKey
            DependencyProperty.Register("LayoutAlgorithm", typeof(ILayoutAlgorithm<TVertex, TEdge, TGraph>),// bcz: RegisterReadOnly
                                                typeof(GraphLayout<TVertex, TEdge, TGraph>),
                                                new PropertyMetadata(null)); // bcz: new UIPropertyMetadata( null ) );
        ...
        public static readonly DependencyProperty LayoutModeProperty = DependencyProperty.Register("LayoutMode",
                                        typeof(LayoutMode),
                                        typeof(GraphLayout<TVertex, TEdge, TGraph>),
                                        new PropertyMetadata(LayoutMode.Automatic, LayoutMode_PropertyChanged));// , LayoutMode_Coerce));
        ...
        protected static readonly DependencyProperty  LayoutStatePropertyKey =// bcz: DependencyPropertyKey
            DependencyProperty.Register("LayoutState", typeof(LayoutState<TVertex, TEdge>),// bcz: RegisterReadOnly
                                                typeof(GraphLayout<TVertex, TEdge, TGraph>),
                                                 new PropertyMetadata(null)); // bcz: new UIPropertyMetadata( null ) );

        public static readonly DependencyProperty LayoutStatusPercentProperty;

        protected static readonly DependencyProperty LayoutStatusPercentPropertyKey =// bcz: DependencyPropertyKey
            DependencyProperty.Register("LayoutStatusPercent", typeof(double),// bcz: RegisterReadOnly
                                                typeof(GraphLayout<TVertex, TEdge, TGraph>),
                                                new PropertyMetadata(0.0)); // bcz: new UIPropertyMetadata( 0.0 ) );
        ...
        public static readonly DependencyProperty OverlapRemovalAlgorithmFactoryProperty =
            DependencyProperty.Register("OverlapRemovalAlgorithmFactory",
                                        ...
                                        typeof(GraphLayout<TVertex, TEdge, TGraph>),
                                        new PropertyMetadata(new StandardOverlapRemovalAlgorithmFactory<TVertex>(), null)); // , OverlapRemovalAlgorithmFactory_Coerce));

        public static readonly DependencyProperty OverlapRemovalAlgorithmProperty;

        protected static readonly DependencyProperty  OverlapRemovalAlgorithmPropertyKey =// bcz: DependencyPropertyKey
            DependencyProperty.Register("OverlapRemovalAlgorithm", typeof(IOverlapRemovalAlgorithm<TVertex>), // bcz: RegisterReadOnly
                                                typeof(GraphLayout<TVertex, TEdge, TGraph>),
                                        new PropertyMetadata(null)); // bcz: new UIPropertyMetadata( null ) );
        ...
        protected static readonly DependencyProperty StateCountPropertyKey = // bcz: DependencyPropertyKey
            DependencyProperty.Register("StateCount", typeof(int), typeof(GraphLayout<TVertex, TEdge, TGraph>),// bcz: RegisterReadOnly
                                                new  PropertyMetadata(0, StateCount_PropertyChanged)); // bcz: UIPropertyMetadata

        public static readonly DependencyProperty StateIndexProperty = DependencyProperty.Register("StateIndex",
                                               typeof(int),
                                               typeof(GraphLayout<TVertex, TEdge, TGraph>),
                                               new PropertyMetadata(0, StateIndex_PropertyChanged)); // new UIPropertyMetadata StateIndex_Coerce));
        ...
        static GraphLayout()
        {
            ...
            StateCountProperty = StateCountPropertyKey; // bcz:
            LayoutStatusPercentProperty = LayoutStatusPercentPropertyKey;
            LayoutAlgorithmProperty = LayoutAlgorithmPropertyKey;
            OverlapRemovalAlgorithmProperty = OverlapRemovalAlgorithmPropertyKey;
            EdgeRoutingAlgorithmProperty = EdgeRoutingAlgorithmPropertyKey;
            LayoutStateProperty = LayoutStatusPercentPropertyKey;
            HighlightAlgorithmProperty = HighlightAlgorithmPropertyKey;
        }
        ...
        public GraphLayout()
        {
            ...
            //           new HighlightTriggerEventHandler(HighlightTriggerEventHandler), false /*bcz:*/);
        }
        ...
        {
            get { return (IHighlightAlgorithm<TVertex, TEdge, TGraph>)GetValue(HighlightAlgorithmPropertyKey); }
