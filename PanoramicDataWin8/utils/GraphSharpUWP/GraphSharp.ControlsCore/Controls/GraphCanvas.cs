...
namespace GraphSharp.Controls
{
    public class GraphCanvas : Canvas
    {
       ...
       //[AttachedPropertyBrowsableForChildren]
        public static double GetY(UIElement obj)
        {
        ...
        //    UIElement e = d as UIElement;
        //    if (e != null)
        //        e.AddHandler(PositionChangedEvent, handler, false /*bcz: */);
        //}
        ...
        protected override Size ArrangeOverride(Size arrangeSize)
        {
            ...
            graphSize = Children.Count > 0// bcz: InternalChildren
                            ? new Vector(double.NegativeInfinity, double.NegativeInfinity)
                            : new Vector(0, 0);

            //translate with the topLeft
            foreach (UIElement child in Children)// bcz: InternalChildren
            {
                double x = GetX(child);
                double y = GetY(child);
                ...
                child.Arrange(new Windows.Foundation.Rect(x, y, child.DesiredSize.Width, child.DesiredSize.Height));  // bcz: new Rect(new Point(x, y), child.DesiredSize));
        ...
        protected override Size MeasureOverride(Size constraint)
        {
            ...
            var graphSize = new Size(bottomRight.X - topLeft.X, bottomRight.Y - topLeft.Y); // bcz:  (Size)(bottomRight - topLeft);
        ...
        public static readonly DependencyProperty AnimationLengthProperty =
            DependencyProperty.Register("AnimationLength", typeof(TimeSpan), typeof(GraphCanvas), new PropertyMetadata(new TimeSpan(0, 0, 0, 0, 500))); // bcz:  new UIPropertyMetadata(new TimeSpan(0, 0, 0, 0, 500)));
        #endregion
        ...
        public static readonly DependencyProperty CreationTransitionProperty =
            DependencyProperty.Register("CreationTransition", typeof(ITransition), typeof(GraphCanvas), new PropertyMetadata(new FadeInTransition()));//bcz: new UIPropertyMetadata(new FadeInTransition()));
        ...
        public static readonly DependencyProperty IsAnimationEnabledProperty =
            DependencyProperty.Register("IsAnimationEnabled", typeof(bool), typeof(GraphCanvas), new PropertyMetadata(true)); //  new UIPropertyMetadata(true));
        ...
        public static readonly DependencyProperty MoveAnimationProperty =
            DependencyProperty.Register("MoveAnimation", typeof(IAnimation), typeof(GraphCanvas), new PropertyMetadata(new SimpleMoveAnimation())); //  new UIPropertyMetadata(new SimpleMoveAnimation()));
        ...
        public static readonly DependencyProperty DestructionTransitionProperty =
            DependencyProperty.Register("DestructionTransition", typeof(ITransition), typeof(GraphCanvas), new PropertyMetadata(new FadeOutTransition()));// bcz: new UIPropertyMetadata(new FadeOutTransition()));
        ...
        protected static readonly DependencyProperty TranslationPropertyKey = // bcz: DependencyPropertyKey
            DependencyProperty.Register("Translation", typeof(Vector), typeof(GraphCanvas), // bcz: RegisterReadOnly
                        new PropertyMetadata(new Vector())); // bcz: new UIPropertyMetadata(new Vector()));

        static GraphCanvas()
        {
            TranslationProperty = TranslationPropertyKey; //bcz: .DependencyProperty;
        }
        ...
        protected virtual void RunDestructionTransition(Control control, bool dontRemoveAfter)
        {
            ...
            else
            {
                if (dontRemoveAfter)
                    ...
                    DestructionTransition.Run(AnimationContext, control, AnimationLength, RemoveChild);
            }
        }
        //bcz:
