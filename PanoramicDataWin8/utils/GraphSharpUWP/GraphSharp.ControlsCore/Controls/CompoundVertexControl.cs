...
namespace GraphSharp.Controls
{
    ...
    public class CompoundVertexControl : VertexControl, ICompoundVertexControl
    {
        ...
        /// </summary>
        protected override void OnApplyTemplate() // bcz: public
        {
        ...
        protected static readonly DependencyProperty VerticesPropertyKey =// bcz: DependencyPropertyKey
            DependencyProperty.Register("Vertices", typeof(ObservableCollection<VertexControl>), // bcz: RegisterReadOnly
                typeof(CompoundVertexControl), new PropertyMetadata(null)); // bcz: new UIPropertyMetadata(null));
        ...
        public static readonly DependencyProperty LayoutModeProperty =
            DependencyProperty.Register("LayoutMode", typeof(CompoundVertexInnerLayoutType), typeof(CompoundVertexControl), new PropertyMetadata(CompoundVertexInnerLayoutType.Automatic)); // bcz: new UIPropertyMetadata(CompoundVertexInnerLayoutType.Automatic));
        ...
        public static readonly DependencyProperty InnerCanvasOrigoProperty =
            DependencyProperty.Register("InnerCanvasOrigo", typeof(Point), typeof(CompoundVertexControl), new PropertyMetadata(new Point())); // bcz:  new UIPropertyMetadata(new Point()));


        static CompoundVertexControl()
        {
            //readonly DPs
            VerticesProperty = VerticesPropertyKey; //bcz: .DependencyProperty;
            ...
            else
            {
                ...
                if (compoundVertexControl.Vertices.Contains(childVertexControl))
                {
                    ...
                    foreach (var cvc in compoundVertexControl.Vertices)
                    {
                        ...
                        var translatedChildCenterPos = cvc.TransformToVisual(cvc.RootCanvas).TransformPoint(childCenterPos); // bcz:  .TranslatePoint(childCenterPos, cvc.RootCanvas);
        ...
        {
            add { AddHandler(ExpandedEvent, value, false /* bcz: */); }
        ...
        {
            add { AddHandler(CollapsedEvent, value, false /* bcz: */); }
        ...
        public Thickness VertexBorderThickness
        {
            get
            {
                ...
                var innerCanvasPosition = _innerCanvas.TransformToVisual(this).TransformPoint(new Windows.Foundation.Point()); // bcz: .TranslatePoint(new Point(), this);
