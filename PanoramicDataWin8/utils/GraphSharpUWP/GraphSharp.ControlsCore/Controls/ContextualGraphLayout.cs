...
namespace GraphSharp.Controls
{
		...
		where TGraph : class, IBidirectionalGraph<TVertex, TEdge>
	{
		...
		public static readonly DependencyProperty SelectedVertexProperty = DependencyProperty.Register( "SelectedVertex", typeof( TVertex ), typeof( ContextualGraphLayout<TVertex, TEdge, TGraph> ), new PropertyMetadata( default( TVertex ), SelectedVertex_PropertyChanged ) ); // bcz: UIPropertyMetadata
		...
		{
			// bcz : LayoutAlgorithmFactoryProperty.OverrideMetadata( typeof( ContextualGraphLayout<TVertex, TEdge, TGraph> ), new PropertyMetadata( new ContextualLayoutAlgorithmFactory<TVertex, TEdge, TGraph>(), null, LayoutAlgorithmFactory_Coerce ) );
		}
