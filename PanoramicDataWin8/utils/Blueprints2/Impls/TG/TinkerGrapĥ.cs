...
namespace Frontenac.Blueprints.Impls.TG
{
    ...
    public class TinkerGrapĥ : IIndexableGraph, IKeyIndexableGraph
    {
        ...
        public virtual IIndex GetIndex(string indexName, Type indexClass)
        {
            ...
            if (null == index)
                return null;
            Debug.WriteLine("Possible error GetIndex");
        ...
        {
            Debug.WriteLine("Possible error CreateKeyIndex");
        ...
        {
            Debug.WriteLine("Possible error DropKeyIndex");
            //if (typeof (IVertex).IsAssignableFrom(elementClass))
        ...
        {
            Debug.WriteLine("Possible error GetIndexedKeys");
