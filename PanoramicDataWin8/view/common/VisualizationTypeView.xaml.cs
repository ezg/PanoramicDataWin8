...
{
    public sealed partial class VisualizationTypeView : UserControl
    {
        private VisualizationTypeView _shadow = null;
        ...
        public VisualizationTypeView()
        {
            this.InitializeComponent();
            this.DataContextChanged += VisualizationTypeView_DataContextChanged;
        ...
        void VisualizationTypeView_DataContextChanged(FrameworkElement sender, DataContextChangedEventArgs args)
        {
            if (args.NewValue != null && args.NewValue is VisualizationTypeViewModel)
            {
                (args.NewValue as VisualizationTypeViewModel).PropertyChanged += VisualizationTypeViewModel_PropertyChanged;
                updateRendering();
            }
        }

        void VisualizationTypeViewModel_PropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            updateRendering();
        }
        ...
        {
            VisualizationTypeViewModel model = DataContext as VisualizationTypeViewModel;
            ...
            if (e.NumActiveContacts == 1)
            {
                ...
                if (_shadow != null)
                {
                    ...
                    if (inkableScene != null)
                    {
                        ...
                        (DataContext as VisualizationTypeViewModel).FireMoved(bounds);
                    }
                }
        ...
        void mainPointerManager_Removed(object sender, PointerManagerEvent e)
        {
            ...
            if (_shadow != null)
            {
                ...
                Rct bounds = _shadow.GetBounds(inkableScene);
                (DataContext as VisualizationTypeViewModel).FireDropped(bounds);
        ...
        public void createShadow(Point fromInkableScene)
        {
            ...
            if (inkableScene != null && DataContext != null)
            {
                ...
                _shadow = new VisualizationTypeView();
                _shadow.DataContext = new VisualizationTypeViewModel()
                {
                    VisualizationType = (DataContext as VisualizationTypeViewModel).VisualizationType,
                    IsShadow = true
                };
