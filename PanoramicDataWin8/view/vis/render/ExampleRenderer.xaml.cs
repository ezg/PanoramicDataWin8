...
{
    public sealed partial class ExampleRenderer : Renderer, IScribbable
    {
        ...
        {
            ExampleOperationViewModel model = (DataContext as ExampleOperationViewModel);
        ...
        public IGeometry Geometry
        {
            get
            {
                ExampleOperationViewModel model = this.DataContext as ExampleOperationViewModel;
